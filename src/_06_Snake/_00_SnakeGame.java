...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Move the snake with the arrow keys.\nAvoid hitting yourself or the boundary.\nCollect the food by moving over it";
	...
	private void gameOver() {
		...
		int userChoice = JOptionPane.showConfirmDialog(null, "Do you want to play again?");
